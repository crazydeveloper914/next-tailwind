...
const generateEmailContent = (data: any): generateEmailContent => {
	...
	// Contact Form HTML Template (HEADER)
	const html: string = `
		<!DOCTYPE html>
		...
		<html>
			...
			<body
				style="margin: 0 !important; padding: 0 !important; background: #012a2d"
			>
				<div
					style="
						display: none;
...
export default async function handler(req: any, res: any) {
	if (req.method === "POST") {
		...
		// Contact Form HTML Template (BODY)
		const html: string = `
			<!DOCTYPE html>
																			...
																			>
																				...
																				>
																					<a
																						...
																						target="_blank"
																						><img
																							alt="MponjoliMpeli Limited Logo"
																							src="https://cmsmponjolimpeliapartments.co.uk/wp-content/uploads/2023/03/cropped-MponjoliMpeli-Apartments-Logo-Icon.png"
																							style="
																								border: 0;
																								width: 75px;
																								height: 75px;
																					...
																					<tr>
																						...
																						>
																							<div class="menu-links">
																								...
																								[endif]-->[endif]--><!--[if mso]><td style="padding-top:0px;padding-right:15px;padding-bottom:5px;padding-left:15px"><![endif]-->
																								<a
																									href="https://cmsmponjolimpeliapartments.co.uk/wp-admin"
																									style="
																										mso-hide: false;
																										padding-top: 0px;
																										padding-bottom: 5px;
																								...
																								[endif]-->[endif]--><!--[if mso]><td style="padding-top:0px;padding-right:15px;padding-bottom:5px;padding-left:15px"><![endif]-->
																								<a
																									href="https://mponjolimpeliapartments.vercel.app/contact"
																									style="
																										mso-hide: false;
																										padding-top: 0px;
																										padding-bottom: 5px;
																		...
																		<tr>
																			...
																			>
																				<h1
																					...
																					"
																				>
																					MponjoliMpeli Apartments is an established
																					apartment development & Letting company.
																				</h1>
																			</td>
																		</tr>
																	</table>
																...
																>
																			...
																			<td class="pad" style="padding-top: 30px">
																				<div style="font-family: sans-serif">
																					...
																					>
																						...
																						>
																							<span style="font-size: 16px">
																								${body.phoneNumber ? body.phoneNumber : "No Number"}
																							</span>
																						</p>
																	...
																	>
																		<tr>
																			...
																			>
																				<div align="center" class="alignment">
																					<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.example.com/" style="height:42px;width:215px;v-text-anchor:middle;" arcsize="0%" stroke="false" fillcolor="#00946a"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#012a2d; font-family:Arial, sans-serif; font-size:16px"><!
																					[endif]--><a
																						href="https://cmsmponjolimpeliapartments.co.uk/wp-admin"
																						style="
																							text-decoration: none;
																							...
																							border-radius: 0px;
																							width: auto;
																							border-top: 0px solid #00946a;
																							font-weight: 700;
																							border-right: 0px solid #00946a;
																							border-bottom: 0px solid #00946a;
																							border-left: 0px solid #00946a;
																							padding-top: 5px;
																							padding-bottom: 5px;
																							font-size: 16px;
																							text-align: center;
																			...
																			>
																				...
																				>
																					<img
																						alt="Artist"
																						class="big"
																						src="https://cmsmponjolimpeliapartments.co.uk/wp-content/uploads/2023/09/pexels-gustavo-fring-4971220-scaled.jpg"
																						style="
																							border: 0;
																							width: 100%;
																							height: 250px;
																				...
																				<div>
																					...
																					>
																						<p
																							...
																							"
																						>
																							© 2024 MponjoliMpeli Limited. All rights
																							reserved.
																						</p>
																					</div>
																				</div>
		...
		try {
			await transporter.sendMail({
				...
				subject: `New website enquiry: ${
					body?.subject ? body?.subject : "Customer Enquiry"
				}`,
